...
public class EnemyController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (currentHealth > 0)
        {
            ...
            if (distance < 9.0f || bypassDistance)
            {
            ...
            if (distance < 1.9f && isAttacking == false)
            {
                ...
                targetPlayerObject.GetComponent<PlayerMovement>().takeDamage(10);
            }
            else
            {
            ...
            anim.SetFloat("hız", (_agent.velocity.magnitude * Time.deltaTime) * 100);
        }
